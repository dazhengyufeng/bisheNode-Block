...
class Block {
   ...
   * @param {String} previousHash 上一个区块的hash
   * @param {Number} timestamp 时间戳
   * @param {*} data 区块内容
   * @param {String} hash 本区块hash
   */
...
class BlockChain {
   ...
   */
  getGenesisBlock() {
    return new Block(0, '0', 1552801194452, '初始区块', '810f9e854ade9bb8730d776ea02622b65c02b82ffa163ecfe4cb151a14412ed4')
  }
